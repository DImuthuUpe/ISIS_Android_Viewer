...
public class Resource {
    ...
    public static  Resource DomainObjectAction =
        new Resource("/objects/{domainType}/{instanceId}/actions/{actionId}");

    public static  Resource DomainServiceActionInvoke =
        new Resource("/services/{serviceId}/actions/{actionId}/invoke");

    public static  Resource DomainObjectActionInvoke =
    ...
    public static  Resource DomainTypeProperty =
        new Resource("/domain-types/{domainType}/properties/{propertyId}");

    public static  Resource DomainTypeCollection =
    ...
    public static  Resource DomainTypeActionParam =
        new Resource("/domain-types/{domainType}/actions/{actionId}/params/{paramName}");

    public static  Resource DomainTypeActionInvoke =
