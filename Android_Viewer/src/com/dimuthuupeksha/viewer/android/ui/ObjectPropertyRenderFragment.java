...
public class ObjectPropertyRenderFragment extends SherlockFragment implements ActionBar.TabListener{
    ...
    public void refresh() {
        if (!refreshed) {
            new ResolveReferenceTask(ObjectPropertyRenderFragment.this).execute();
            refreshed = true;
        }
    }
    ...
    private void render(Map<String, Map<String, Object>> referenceMap) { // <key,
        ...
        while (it.hasNext()) {
            ...
            if (isChoice) {
                ...
                ArrayAdapter spinnerArrayAdapter = new ArrayAdapter(this.getActivity(), android.R.layout.simple_spinner_dropdown_item, choices);
                ...
                View view = ViewMapper.convertToView(dataType, this.getActivity(), propertyMember.get(id).getValue().getValueAsText());
        ...
        if (arguments != null) {
            updateButton = new Button(this.getActivity());
        ...
        ScrollView scView = new ScrollView(this.getActivity());
        scView.addView(layout);
        getSherlockActivity().setContentView(scView);
    }
    ...
    private void onUpdateButtonClick() {
        ...
        okButton = new Button(this.getActivity());
        okButton.setText("OK");
        ...
        cancelButton = new Button(this.getActivity());
    ...
    private class ResolveReferenceTask extends AsyncTask<Void, Void, Map<String, Map<String, Object>>> {
        ...
        public ResolveReferenceTask(ObjectPropertyRenderFragment fragment) {
    ...
    private class UpdateTask extends AsyncTask<Map<String, Object>, Void, Void> {
        ...
        protected Void doInBackground(Map<String, Object>... arg0) {
            try {
                ...
                try {
                    ...
                    Intent intent = new Intent(ObjectPropertyRenderFragment.this.getActivity(), ObjectRenderActivity.class);
        ...
        protected void onPostExecute(Void result) {
            if (error == INVALID_CREDENTIAL) {
                ...
                Intent intent = new Intent(ObjectPropertyRenderFragment.this.getActivity(), LogInActivity.class);
                ObjectPropertyRenderFragment.this.getActivity().startActivity(intent);
            }

            if (error == CONNECTION_ERROR) {
                /** Show the error Dialog */
                AlertDialog alertDialog = new AlertDialog.Builder(ObjectPropertyRenderFragment.this.getActivity()).create();
    ...
    public void onTabSelected(Tab tab, FragmentTransaction ft) {
        ...
        mFragment = new ObjectPropertyRenderFragment();
